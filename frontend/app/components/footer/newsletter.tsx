...
export function NewsletterSignUp({
  ...
  description = "If you are a large organization, brand, or agency looking to strategically partner with Twinn, contact us to learn more about our premium enterprise capabilities.",
