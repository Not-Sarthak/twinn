...
>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "bg-primary/50 hover:bg-primary-50 w-[350px] rounded-[24px] border-4 border-white p-2 no-underline shadow-sm transition-colors",
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("mt-2 text-lg font-semibold leading-tight", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("pb-2 text-sm text-neutral-500", className)}
    {...props}
  />
));
